  ...
  summary: [
    {
      ...
      note: `${METRICS.share_of_voice.plain}. Across all 412 tracked prompts; Adidas ends 24.9%, Brooks 18.8%, Asics 13.1%.`,
    },
    {
    ...
    },
    {
      ...
      delta: "-0.7pt",
      note: "40 prompts and Brooks leads them — the smallest tracked topic block.",
    },
    {
      label: "Biggest decline",
      value: "Sustainability — 18.7%",
      delta: "-2.1pt",
      note: "48 prompts, and Asics leads it on Claude — a visibility gap worth closing.",
    },
    {
  ...
  sections: [
    ...
    }),
    {
      ...
      rows: [
        ...
        ["Sustainability", "48", "18.7%", "-2.1", "Claude", "Asics"],
        ["Basketball gear", "40", "14.2%", "-0.7", "Gemini", "Brooks"],
      ],
    },
    {
...
export const regionsSpec: ReportSpec = {
  ...
  summary: [
    ...
    },
    {
      ...
      delta: "flat",
      note: "8.1% share of voice, Asics leads. No movement in the window.",
    },
    {
      label: "Only declining region",
      value: "France — 22.1% visibility",
      delta: "-0.8pt",
      note: "Brooks leads French answers; the sole region losing ground this window.",
    },
    {
      label: "Coverage",
  ...
  sections: [
    ...
    },
    {
      ...
      rows: [
        ...
        ["France", "French", "22.1%", "18.6%", "-0.8", "Brooks"],
        ["Brazil", "Portuguese", "12.2%", "10.4%", "+1.1", "Adidas"],
        ["Japan", "Japanese", "9.8%", "8.1%", "—", "Asics"],
      ],
    },
  ],
  footnotes: [
