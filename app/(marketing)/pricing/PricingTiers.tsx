            ...
            <table style={{width:"100%",borderCollapse:"collapse",fontSize:"12.5px"}}>
              ...
              <tbody style={{fontVariantNumeric:"tabular-nums"}}>
                {[
                  ...
                  ["Named success engineer · 99.9% SLA", dash, dash, check],
                ].map(([label, g, s, e], i) => (
                  <tr key={i}>
